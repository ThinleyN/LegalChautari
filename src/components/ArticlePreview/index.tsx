...
const ArticlePreview: React.FC<ArticleProps> = ({ data }) => {
    ...
    return (
        <Link href={`/article/${slug?.current}`} className="w-full lg:w-[30%] rounded-xl p-7 shadow-xl group duration-300 transition-all hover:scale-[1.02] cursor-pointer mb-3 md:mb-0">
